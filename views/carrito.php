                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div id="container-envio">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" id="nombre" type="text" autocomplete="off" placeholder="Ejemplo: Juan">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text">Dirección</span>
                                <input class="form-control" id="direccion" type="text" autocomplete="off" placeholder="Calle 121 Av 105">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text">Telefono</span>
                                <input class="form-control" id="telefono" type="text" autocomplete="off" placeholder="0987685943">
                            </div>
